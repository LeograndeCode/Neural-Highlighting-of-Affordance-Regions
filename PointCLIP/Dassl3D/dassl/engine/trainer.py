...
class SimpleTrainer(TrainerBase):
    ...
    def __init__(self):                                         #NEURAL_HIGHLIGHTING_CUSTOM
        super().__init__()
        
        self.cfg = None                                         #NEURAL_HIGHLIGHTING_CUSTOM
        if torch.cuda.is_available():                           #NEURAL_HIGHLIGHTING_CUSTOM
        ...
        self.max_epoch = 10                                     #NEURAL_HIGHLIGHTING_CUSTOM cfg.OPTIM.MAX_EPOCH 
        self.output_dir = './output_PointCLIP'                  #NEURAL_HIGHLIGHTING_CUSTOM cfg.OUTPUT_DIR

        #self.cfg = cfg                                         #NEURAL_HIGHLIGHTING_CUSTOM
